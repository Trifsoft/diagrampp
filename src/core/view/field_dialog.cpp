...
std::optional<Field> FieldDialog::create_field(QWidget* parent)
{
    ...
    if (dialog.exec() == QDialog::Accepted) {
        ...
        // Create a field
        Field field(dialog.get_name(), dialog.get_type(), dialog.get_visibility(), dialog.get_destruction());
...
std::optional<Field> FieldDialog::edit_field(const Field& field, QWidget* parent)
{
    ...
    if (dialog.exec() == QDialog::Accepted) {
        ...
        Field updated(dialog.get_name(), dialog.get_type(), dialog.get_visibility(), dialog.get_destruction());
